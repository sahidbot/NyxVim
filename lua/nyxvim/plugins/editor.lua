    ...
    keys = {
      {
        "<leader>fe",
        function()
          require("neo-tree.command").execute({ toggle = true, dir = require("nyxvim.util").get_root() })
        end,
      ...
      vim.schedule(function()
        ...
        if Config.spec.disabled["leap.nvim"] or Config.spec.disabled["flit.nvim"] then
          require("lazy.core.util").warn(
            [[`flash.nvim` is now the default **NyxVim** jump plugin.
...
`nyxvim.plugins.extras.editor.leap`
  ...
  -- Flash Telescope config
  {
    ...
    opts = function(_, opts)
      if not require("nyxvim.util").has("flash.nvim") then
        return
      end
